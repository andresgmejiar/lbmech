...
```{r, include = FALSE}
# Knested list function taken from 
# https://gist.github.com/billdenney/5ef10d82e6bcdbcac4f0f38562c23b53
# This is so the lists of Rasterstacks can be displayed on Github
...
velocityPrint <- knested_list(velocity)
```
...
structure anyways:
```{r velocity, results = 'hide', echo = F}
print(velocity)
```
```{r, echo = FALSE}
print(velocityPrint)
...
knested_list(structure(costRasters))
```
