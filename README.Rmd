...
Hiking function $d\ell/dt = v_{\mathrm{max}} e^{-k | dz/d\ell - \alpha |},$
where $\ell$ is horizontal displacement, $t$ time, $d\ell/dt$ horizontal
speed, $v_{\mathrm{max}}$ the maximum walking speed, $dz/d\ell$ the 
