...
D = w_i * \ell_i
```
where $D$ is the modified distance, $w_i$ the weight of point $i$, and $\ell$ the raw distance to point $i$. `lbmech` provides a fully vectorized function to calculate such catchments for planar, spherical, and Earth-geoid topologies through the `lbmech::mwVoronoi` function:
